...
// Modificado: filtrar solo inmuebles en oferta
const listaInmuebles = computed(() => {
  return listaInmueblesCompleta.value.filter(inmueble => inmueble.offer === true);
});
    ...
    <div v-if="!verDetalle" class="inmuebles-grid">
      ...
      <div v-for="inmueble in listaInmuebles" :key="inmueble.id" class="inmueble-card">
        ...
        <div class="inmueble-info">
          ...
          <div class="etiquetas">
            <span class="etiqueta" :class="inmueble.rent ? 'alquiler' : 'venta'">
              {{ inmueble.rent ? 'Alquiler' : 'Venta' }}
            </span>
          ...
          <div class="precio-info">
            ...
            <span class="precio-final">
              {{ formatearPrecio(calcularPrecioConDescuento(inmueble.Regular_Price, inmueble.Discounted_Price)) }}
            </span>
            <span class="periodo">{{ inmueble.rent ? '/ mes' : '' }}</span>
          </div>
    ...
    <div v-if="verDetalle && inmuebleSeleccionado" class="detalle-inmueble">
      ...
      <div class="info-detalle">
        <div class="seccion-precio">
          <div class="etiquetas">
            <span class="etiqueta" :class="inmuebleSeleccionado.rent ? 'alquiler' : 'venta'">
              {{ inmuebleSeleccionado.rent ? 'Alquiler' : 'Venta' }}
            </span>
            <span class="etiqueta oferta">Oferta</span>
          </div>
          ...
          <div class="precio-info">
            ...
            <span class="precio-final">
              {{ formatearPrecio(calcularPrecioConDescuento(inmuebleSeleccionado.Regular_Price, inmuebleSeleccionado.Discounted_Price)) }}
            </span>
            <span class="periodo">{{ inmuebleSeleccionado.rent ? '/ mes' : '' }}</span>
          </div>
        </div>
